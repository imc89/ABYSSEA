...
const FISH_CATALOG = [
    ...
    {
        id: 'sardina',
        nombreKey: 'fish_sardine_name',
        cientificoKey: 'Sardina pilchardus',
        imagen: './img/fishes/fish.png',
        descripcionKey: 'fish_sardine_desc',
        esCardumen: true,
        huyeDelJugador: true,
        distanciaCardumen: 0,
    ...
    {
        id: 'Anoplogaster',
        nombreKey: 'fish_anoplogaster_name',
        cientificoKey: 'Anoplogaster',
        imagen: './img/fishes/ANOPLOGASTER/ANOPLOGASTER.gif',
        descripcionKey: 'fish_anoplogaster_desc',
        esCardumen: false,
    ...
    {
        id: 'beroe',
        nombreKey: 'fish_beroe_name',
        cientificoKey: 'Beroe',
        imagen: './img/fishes/beroe.gif',
        descripcionKey: 'fish_beroe_desc',
        esCardumen: false,
        huyeDelJugador: false,
        distanciaCardumen: 500,
    ...
    {
        id: 'melanocetus',
        nombreKey: 'fish_melanocetus_name',
        cientificoKey: 'Melanocetus jhonsonii',
        imagen: './img/fishes/MELANOCETUS/MELANOCETUS.gif',
        descripcionKey: 'fish_melanocetus_desc',
        esCardumen: false,
        huyeDelJugador: false,
        distanciaCardumen: 500,
    ...
    {
        id: 'malacosteus',
        nombreKey: 'fish_malacosteus_name',
        cientificoKey: 'Malacosteus Niger',
        imagen: './img/fishes/MALACOSTEUS/MALACOSTEUS.gif',
        descripcionKey: 'fish_malacosteus_desc',
        esCardumen: false,
        huyeDelJugador: false,
        distanciaCardumen: 500,
